...
from marchhare.Utils3 import ( Stopwatch , strip_EXT , yesno , unpickle_dict ,
                               ...
                               confirm_or_crash , LogMH , parse_lines )
...
class Session:
    ...
    def default_session( self ):
        ...
        self.RAW_FILE_DIR       = "output";                                 print( "RAW_FILE_DIR:" , cRAW_FILE_DIR )
        self.CHOPPED_SONG_DIR   = session.RAW_FILE_DIR + "/chopped";        print( "CHOPPED_SONG_DIR:" , self.CHOPPED_SONG_DIR )
        self.PICKLE_DIR         = "";                                       print( "PICKLE_DIR:" , self.PICKLE_DIR )
        self.LOG_DIR            = "logs";                                   print( "LOG_DIR" , self.LOG_DIR )
        self.RECORD_PICKLE_PATH = session.PICKLE_DIR + "/music_record.pkl"; print( "ARTIST_PICKLE_PATH:" , self.ARTIST_PICKLE_PATH )
        self.ARTIST_PICKLE_PATH = session.PICKLE_DIR + "/artists.pkl";      print( "ARTIST_PICKLE_PATH:" , self.ARTIST_PICKLE_PATH )
